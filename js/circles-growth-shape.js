...
restrictionShape = new Circle(width * 0.5, height * 0.5);
restrictionShape.r = Math.min(width, height) * 0.45;
...
function posInsideShape(x, y) {
    return dist(x, y, restrictionShape.x, restrictionShape.y) < restrictionShape.r;
}
